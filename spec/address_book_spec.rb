...
RSpec.describe AddressBook do
  ...
  describe "#import_from_csv" do
    ...
    it "imports the 1st entry" do
      ...
      check_entry(entry_one, "Bill", "555-555-4854", "billy@blocmail.com")
    end
  ...
  describe "#binary_search" do
    ...
    it "searches AddressBook for Bill" do
      ...
      check_entry(entry, "Bill", "555-555-4854", "billy@blocmail.com")
    end
  ...
  describe "#iterative_search" do
    it "searches AddressBook for a non-existent entry" do
      book.import_from_csv("entries.csv")
      entry = book.iterative_search("Ed")
      expect(entry).to be_nil
    end
    ...
    it "searches AddressBook for Bobbie" do
      book.import_from_csv("entries.csv")
      entry = book.iterative_search("Bobbie")
      expect(entry).to be_nil
    end
